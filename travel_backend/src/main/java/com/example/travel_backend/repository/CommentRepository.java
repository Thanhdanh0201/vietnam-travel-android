...
public interface CommentRepository extends JpaRepository<Comment, UUID> {
    ...
    Page<Comment> findByPostIdAndParentCommentIsNullAndIsDeletedFalseOrderByCreatedAtAsc(UUID postId, Pageable pageable);

    List<Comment> findByParentCommentIdAndIsDeletedFalseOrderByCreatedAtAsc(UUID parentCommentId);

    List<Comment> findByPost_IdAndIsDeletedFalse(UUID postId);
